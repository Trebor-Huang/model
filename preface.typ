...
类型论的语法与语义互相作用。为了描述某些语义对象，我们从这些对象的结构中提取出一套类型论的语法。而研究这套语法的性质时，又会提出别的模型为它提供语义。因此，若要理解当代前沿类型论的发展，对于模型与语义的理解就尤为重要。

本书的首要目的是为中文读者提供尽可能准确而不过时的介绍。同时，我也希望其中的表述对计算机与数学专业的读者都足够易懂。为此，书中包含许多例子，藉以展示实操用到的种种技术。对范畴论的知识要求已尽可能延后，但是鉴于范畴语言的强有效性，自然不可避免用到这些知识。另外，文中所有术语均有中文翻译。若有通行翻译则采用大陆译名，外文人名保留原文不音译。仍有不少暂定译名，欢迎推敲。

对于每位读者来说，本书都很可能会有部分内容不感兴趣或非常不熟悉。读者完全可以跳过这部分内容，或者只作略读。如果遇到难懂、错误或希望修改的部分，欢迎#hyperlink("https://github.com/Trebor-Huang/model/issues")[提出建议]。
