...
以上是具集范畴与展映射范畴本身的定义。擅长范畴论的读者可以尝试证明这些定义的确等价于上文中从概括范畴出发的定义。这里，展映射范畴的定义非常具有纯范畴论的风格。事实上，如果我们按照范畴论保持同构不变性的惯例令，展映射复合同构仍然是展映射，再依次加上 $Sigma$ 与内涵相等类型对应的类型结构，得到的就分别是 Joyal 在范畴类型论~@clans-and-tribes 中提出的 clan 与 tribe 的概念，试译为 “宗” 与 “门”。
