...
良序关系下的元素不仅不存在无穷下降，而且能从小到大排列成一条线。良序关系则可以出现分叉或者合并的情况。例如 $NN$ 与有限集 ${0,1,dots,n}$ 在小于关系下都构成良序关系。进一步，#eq($ (0,0) prec (0,1) prec (0,2) prec dots.c prec (1,0) prec (1,1) prec dots.c $)
